# Generated by Django 2.2.7 on 2022-09-16 07:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.CharField(choices=[('discount_on_total_bill', 'Discount On Total Bill')], max_length=50)),
        ...
        migrations.CreateModel(
            name='OrgDiscounts',
            fields=[
                ('orgdiscountsId', models.AutoField(primary_key=True, serialize=False)),
                ('orgdiscount', models.CharField(blank=True, max_length=100, null=True)),
                ('orgdescription', models.TextField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('orgdiscount_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Discounts')),
                ('orguser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
